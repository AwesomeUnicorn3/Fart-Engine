...
func add_new_table(newTableName, keyName, keyDatatype, keyVisible, fieldName, fieldDatatype, fieldVisible):
...
#
#	current_row_dict = {1 : newOptions_dict}
	add_key(keyName, keyDatatype, keyVisible, true)
	add_field(fieldName, fieldDatatype, fieldVisible, true)
#	current_dict[keyName] = {valueName : "empty"}
#	current_row_dict = {1 : keyName}

	#Get field and add them to column_dict
#	newOptions_dict = {}
#
#	for i in CustomData_dict:
#		var currentKey = CustomData_dict[i]["ItemID"]
...
#			"DataType":
#				print(fieldDatatype)
#				newValue = fieldDatatype
#			"FieldName":
#				newValue = fieldName
#			"RequiredValue":
#				newValue = false
#			"ShowValue":
#				newValue = fieldVisible
#
#		newOptions_dict[currentKey] = newValue
#
#	current_column_dict = {1 : newOptions_dict}
#
#
	...
	data_type = "Row"
	update_dictionaries()
	add_key(newTableName, keyDatatype, keyVisible)
...
func add_key(keyName, datatype, showKey, newTable : bool = false):
