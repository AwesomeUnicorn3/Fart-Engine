extends Control
tool
#onready var DbMan = preload("res://addons/Database_Manager/UDS_Script.gd")
onready var btn_TableSelect = load("res://addons/Database_Manager/Scenes and Scripts/Btn_TableSelect.tscn")
onready var table_list = $VBoxContainer/HBoxContainer/ScrollContainer/Table_Buttons
onready var data = get_node("VBoxContainer/HBoxContainer/ScrollContainer2/TableViewer")
