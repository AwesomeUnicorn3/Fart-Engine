...
#func _ready():
#	get_button_method()
#	$VBox1/HBox1/Existing_Events_Dropdown._set_input_value(str(selected_method_key))
...
func _on_accept_button_up():
	selected_method_key = $VBox1/HBox1/Existing_Events_Dropdown._get_input_value()
