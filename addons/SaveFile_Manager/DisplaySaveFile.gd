...
tool
onready var fileButton = load("res://addons/SaveFile_Manager/Navigation_Button_File.tscn")
onready var tableButton = load("res://addons/SaveFile_Manager/Navigation_Button_table.tscn")
onready var keyButton = load("res://addons/SaveFile_Manager/Navigation_Button_Key.tscn")

onready var value_input = load("res://addons/Database_Manager/Scenes and Scripts/UI_Input_Scenes/Input_Text.tscn")
