...
func load_page_buttons():
	...
	for index in event_dict.size():
		index = str(index + 1)
		var new_button = page_button.instance()
...
func load_event_notes(event_tab):
	...
	var notes_container = add_input_node(1, 1, "Notes", event_dict[event_tab], event_trigger_display, null, input_value, "1", "")
...
#	print(input_value)
	var trigger_selection_container  = add_input_node(1, 1, "Event Trigger", event_dict[event_tab], event_trigger_display, null, input_value, "5", "Event Triggers")
...
#	print(input_value)
	var conditions_container  = add_input_node(1, 1, "Conditions", event_dict[event_tab], conditions_node, null, input_value, "14", "")
...
#	print(input_value)
	var event_animation_container  = add_input_node(1, 1, "Default Animation", event_dict[event_tab], event_trigger_display, null, input_value, "8")
	input_node_array.append(event_animation_container)

func display_condition_list():
	var list_display = preload("res://addons/Event_Manager/Condition_input_form.tscn").instance()
