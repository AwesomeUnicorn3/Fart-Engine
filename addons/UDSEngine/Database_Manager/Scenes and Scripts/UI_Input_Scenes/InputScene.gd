...
#	add_to_group("INPUT")
	...
	labelNode = find_child("Label_Button", true)
	inputNode = find_child("Input", true)
...
func display_edit_table_menu():
	...
	var edit_table_values :Object = load("res://addons/UDSEngine/Database_Manager/Scenes and Scripts/UI_Input_Scenes/popup_edit_table_values.tscn").instantiate()
...
func display_edit_field_menu():
	var edit_field_values :Object = load("res://addons/UDSEngine/Database_Manager/Scenes and Scripts/UI_Input_Scenes/popup_Edit_Field_Values.tscn").instantiate()
	parent_node  = get_main_tab(self)
	var keyName :String = parent_node.Item_Name
	var fieldName :String = labelNode.text
