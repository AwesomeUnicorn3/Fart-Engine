...
func create_sprite_animation():
	...
	var inputArray :Array = dbengine.string_to_array(str(input_data))

	parent_node.add_animation_to_animatedSprite(labelNode.get_text(), inputArray, false,  sprite_player)
