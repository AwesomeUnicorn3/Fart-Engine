...
#	files = list_files_with_param(table_save_path, table_file_format, ["Table Data.json"])
#
...
#	var datatype = $Popups/popup_newValue/PanelContainer/VBox1/HBox1/VBox2/ItemType_Selection.selected_item_index
...
#	var dropdown = $Popups/popup_newValue/PanelContainer/VBox1/HBox1/Table_Selection.selected_item_index
...
#	var dup_check = tableName + table_file_format
#
#
#	if tableName == "":
#		error = 4
