...
func load_dialog_scene():
	...
	if scene_selection_checkbox:
		scene_path = AU3ENGINE.get_default_dialog_scene_path()
	else:
...
func get_variables():
	character_name_checkbox = str_to_var(current_dialog_dictionary["character_name_checkbox"])
	...
	icon_selection_checkbox = str_to_var(current_dialog_dictionary["icon_selection_checkbox"])
	icon_selection_icon = str_to_var(current_dialog_dictionary["icon_selection_icon"])
	icon_selection_sprite = current_dialog_dictionary["icon_selection_sprite"]
	scene_selection_checkbox = str_to_var(current_dialog_dictionary["scene_selection_checkbox"])
...
func set_selected_group_dict_data(dialog_dict):
	...
	var static_dialog_group_data_dictionary :Dictionary = AU3ENGINE.import_data(AU3ENGINE.table_save_path + "Dialog Groups" + AU3ENGINE.table_info_file_format)
